...
HD_PWD='C:/Users/mjrbr/Fibonacci/Fibonacci.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Fibonacci_Top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Fibonacci_Top.tcl
