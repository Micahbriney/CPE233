...
//                                 NS       = st_WB;
                        ...
                        LUI:     ;//NS       = temp_NS; //All signals are alredy set
                        AUIPC:   ;//NS       = temp_NS; //All signals are alredy set
                        JAL:     ;//NS       = temp_NS; //All signals are alredy set
                        JALR:    ;//NS       = temp_NS; //All signals are alredy set
...
//                                 NS       = temp_NS;
                    ...
                    if(intr)begin                       //Interrupt check  
                        if(OPCODE == LOAD)begin
                            NS = st_WB;                 //temporary NS      
                        end else begin
                            NS = st_INTR;               //default to st_FET
                        end
                    end else begin
                        NS = st_FET;
                    end
...
//----------Writeback state---------------------------------------
            st_WB:  begin
				    ...
				    NS        = st_FET;
                    if(intr)begin                   //Interrupt check
                       NS = st_INTR;                //temporary NS      
//                  end else begin
//                       NS = st_FET;               //default to st_FET
                    end
            end
//----------Interrupt state---------------------------------------
            st_INTR: begin
